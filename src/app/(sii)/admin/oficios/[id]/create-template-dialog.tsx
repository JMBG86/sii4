...
export function CreateTemplateDialog({ categoryId }: { categoryId: string }) {
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[600px] max-h-[85vh] flex flex-col">
                <form onSubmit={handleSubmit} className="flex flex-col h-full overflow-hidden">
                    <DialogHeader>
                        <DialogTitle>Criar Modelo de Ofício</DialogTitle>
                        <DialogDescription>
                            Adicione um novo texto padrão para esta categoria.
                        </DialogDescription>
                    </DialogHeader>
